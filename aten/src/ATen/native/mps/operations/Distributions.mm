...
Tensor& uniform_mps_(Tensor& self, double from, double to, const c10::optional<Generator>& gen) {
...
Tensor& normal_mps_(Tensor& self, double mean, double std, const c10::optional<Generator>& gen) {
  return mps::normal_mps_impl(self, mean, std, c10::nullopt, c10::nullopt, gen, "normal");
}

Tensor normal_mps(const Tensor& mean, double std, const c10::optional<Generator>& gen) {
...
Tensor normal_mps(double mean, const Tensor& std, const c10::optional<Generator>& gen) {
...
Tensor normal_mps(const Tensor& mean, const Tensor& std, const c10::optional<Generator>& gen) {
...
Tensor& normal_mps_out(const Tensor& mean, double std, const c10::optional<Generator>& gen, Tensor& self) {
  return mps::normal_mps_impl(self, 0.0, std, mean, c10::nullopt, gen, "normal");
}

Tensor& normal_mps_out(double mean, const Tensor& std, const c10::optional<Generator>& gen, Tensor& self) {
  // when there's no tensor-type mean, we cannot pass scalar mean value due to the order of
  // multiply/add ops in random computation. So we create a mean tensor instead.
  Tensor mean_t = at::full_like(self, Scalar(mean));
  return mps::normal_mps_impl(self, 0.0, 1.0, mean_t, std, gen, "normal");
...
Tensor& normal_mps_out(const Tensor& mean, const Tensor& std, const c10::optional<Generator>& gen, Tensor& self) {
  TORCH_CHECK(mean.numel() == std.numel(), "normal_mps_out: mean and std must have same number of elements")
  return mps::normal_mps_impl(self, 0.0, 1.0, mean, std, gen, "normal");
}

Tensor& bernoulli_out_mps(const Tensor& p_, const c10::optional<Generator>& gen, Tensor& result) {
  result.resize_(p_.sizes());
  return mps::bernoulli_mps_impl(result, p_, gen, __func__);
}

Tensor& bernoulli_mps_(Tensor& self, double p, const c10::optional<Generator>& gen) {
...
Tensor& bernoulli_mps_(Tensor& self, const Tensor& p_, const c10::optional<Generator>& gen) {
  return mps::bernoulli_mps_impl(self, p_, gen, __func__);
}

// random_.from
Tensor& random_mps_(Tensor& self, int64_t from, c10::optional<int64_t> to_opt, const c10::optional<Generator>& gen) {
...
Tensor& random_mps_(Tensor& self, int64_t to, const c10::optional<Generator>& gen) {
  return random_mps_(self, 0, to, gen);
}

Tensor& random_mps_(Tensor& self, const c10::optional<Generator>& gen) {
  return random_mps_(self, 0, c10::nullopt, gen);
}

// Exponential distribution
Tensor& exponential_mps_(Tensor& self, double lambda, const c10::optional<Generator>& gen) {
...
Tensor& randperm_out_mps(int64_t n, const c10::optional<Generator>& generator, Tensor& result) {
...
Tensor multinomial_mps(const Tensor& self, int64_t n_sample, bool with_replacement, const c10::optional<Generator>& gen) {
