...
at::Tensor& random_impl(at::Tensor& self, const c10::optional<Generator>& generator) {
...
at::Tensor& random_from_to_impl(at::Tensor& self, int64_t from, c10::optional<int64_t> to_opt, const c10::optional<Generator>& generator) {
  uint64_t range = 0;
  auto iter = at::TensorIterator::borrowing_nullary_op(self);
  if (to_opt.has_value()) {
    // [from, to)
...
Tensor& normal_impl_(Tensor& self, double mean, double std, const c10::optional<Generator>& gen) {
...
template<template<typename> class normal_kernel, typename RNG>
Tensor& normal_out_impl(Tensor& output, const Tensor& mean, double std, const c10::optional<Generator>& gen) {
  CHECK_NORMAL_STD(std);
...
template<template<typename> class normal_kernel, typename RNG>
Tensor& normal_out_impl(Tensor& output, double mean, const Tensor& std, const c10::optional<Generator>& gen) {
...
template<template<typename> class normal_kernel, typename RNG>
Tensor& normal_out_impl(Tensor& output, const Tensor& mean, const Tensor& std, const c10::optional<Generator>& gen) {
  CHECK_NORMAL_TENSOR_STD(std);
...
template<template<typename> class normal_kernel, typename RNG>
Tensor normal_impl(const Tensor& mean, double std, const c10::optional<Generator>& gen) {
  CHECK_NORMAL_STD(std);
...
template<template<typename> class normal_kernel, typename RNG>
Tensor normal_impl(double mean, const Tensor& std, const c10::optional<Generator>& gen) {
  CHECK_NORMAL_TENSOR_STD(std);
...
template<template<typename> class normal_kernel, typename RNG>
Tensor normal_impl(const Tensor& mean, const Tensor& std, const c10::optional<Generator>& gen) {
  CHECK_NORMAL_TENSOR_STD(std);
  auto shape = at::infer_size(mean.sizes(), std.sizes());
...
at::Tensor& uniform_impl_(at::Tensor& self, double from, double to, const c10::optional<Generator>& generator) {
  if (self.is_complex()) {
    CHECK_EMPTY_AND_RETURN(self);
    auto float_tensor = at::view_as_real(self);
...
at::Tensor& log_normal_impl_(at::Tensor& self, double mean, double std, const c10::optional<Generator>& gen) {
...
Tensor& geometric_impl_(Tensor& self, double p, const c10::optional<Generator>& gen) {
...
Tensor& exponential_impl_(Tensor& self, double lambda, const c10::optional<Generator>& gen) {
...
Tensor& cauchy_impl_(Tensor& self, double median, double sigma, const c10::optional<Generator>& gen) {
...
Tensor& bernoulli_impl_(Tensor& self, const Tensor& p_, const c10::optional<Generator>& gen) {
  CHECK_EMPTY_AND_RETURN(self);
  NoNamesGuard guard;
...
Tensor& bernoulli_impl_(Tensor& self, double p, const c10::optional<Generator>& gen) {
...
template<template<typename> class bernoulli_tensor_kernel, typename RNG>
Tensor& bernoulli_out_impl(Tensor& result, const Tensor& self, const c10::optional<Generator>& gen) {
