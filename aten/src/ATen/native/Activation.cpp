...
Tensor rrelu(const Tensor & self, const Scalar& lower, const Scalar& upper, bool training, const c10::optional<Generator>& generator) {
...
Tensor & rrelu_(Tensor & self, const Scalar& lower, const Scalar& upper, bool training, const c10::optional<Generator>& generator) {
  TORCH_CHECK(lower.to<double>() <= upper.to<double>(), "Lower bound should be less than or equal to the upper bound")
