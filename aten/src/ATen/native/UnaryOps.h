...
DECLARE_DISPATCH(void(*)(const TensorBase&, const TensorBase&, const c10::optional<Generator>&), bernoulli_tensor_stub);
DECLARE_DISPATCH(void(*)(const TensorBase&, const double, const c10::optional<Generator>&), bernoulli_scalar_stub);
DECLARE_DISPATCH(void(*)(TensorIteratorBase&, const double, const double, const c10::optional<Generator>&), cauchy_stub);
DECLARE_DISPATCH(void(*)(TensorIteratorBase&, const double, const c10::optional<Generator>&), exponential_stub);
DECLARE_DISPATCH(void(*)(TensorIteratorBase&, const double, const c10::optional<Generator>&), geometric_stub);
DECLARE_DISPATCH(void(*)(TensorIteratorBase&, const double, const double, const c10::optional<Generator>&), log_normal_stub);
DECLARE_DISPATCH(void(*)(TensorIteratorBase&, const double, const double, const c10::optional<Generator>&), uniform_stub);
DECLARE_DISPATCH(void(*)(const TensorBase&, const double, const double, const c10::optional<Generator>&), normal_stub);
DECLARE_DISPATCH(void(*)(TensorIteratorBase&, const uint64_t, const int64_t, const c10::optional<Generator>&), random_from_to_stub);
DECLARE_DISPATCH(void(*)(TensorIteratorBase&, const c10::optional<Generator>&), random_full_64_bits_range_stub);
DECLARE_DISPATCH(void(*)(TensorIteratorBase&, const c10::optional<Generator>&), random_stub);
...
DECLARE_DISPATCH(
    void (*)(Tensor&, const Tensor&, int64_t, const c10::optional<Generator>&),
