...
struct RandomFromToKernel {
  void operator()(TensorIteratorBase& iter, uint64_t range, int64_t base, const c10::optional<Generator>& gen) {
...
struct BernoulliKernel {
  void operator()(const TensorBase &self, double p, const c10::optional<Generator>& gen) {
    bernoulli_kernel(self, p, check_generator<RNG>(gen));
  }
  void operator()(const TensorBase &self, const TensorBase &p_, const c10::optional<Generator>& gen) {
