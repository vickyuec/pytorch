...
TORCH_API std::vector<torch::lazy::Shape> compute_shape_bernoulli(const at::Tensor & self, const c10::optional<at::Generator> & generator);
TORCH_API std::vector<torch::lazy::Shape> compute_shape_bernoulli(const at::Tensor & self, double p, const c10::optional<at::Generator> & generator);
...
TORCH_API std::vector<torch::lazy::Shape> compute_shape_normal_functional(const at::Tensor & self, double mean, double std, const c10::optional<at::Generator> & generator);
TORCH_API std::vector<torch::lazy::Shape> compute_shape_random(const at::Tensor & self, const c10::optional<at::Generator> & generator);
TORCH_API std::vector<torch::lazy::Shape> compute_shape_random(const at::Tensor & self, int64_t to, const c10::optional<at::Generator> & generator);
TORCH_API std::vector<torch::lazy::Shape> compute_shape_random(const at::Tensor & self, int64_t from, c10::optional<int64_t> to, const c10::optional<at::Generator> & generator);
...
TORCH_API std::vector<torch::lazy::Shape> compute_shape_uniform(const at::Tensor & self, double from, double to, const c10::optional<at::Generator> & generator);
