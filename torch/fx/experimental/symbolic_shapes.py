        ...
        if equalities_inputs:
            ...
            for src, root, fn in equalities_inputs.derived_equalities:
                ...
                if not concrete_val:
                    ...
                    debug_name = self.var_to_sources[root][0].name() if isinstance(root, sympy.Symbol) else self._debug_name(root)
                    raise ConstraintViolationError(
                ...
                if (
                    ...
                    if (
                        ...
                        msg = (
                            ...
                            f"{self._debug_name(source)} = {expr.subs({symbol: sympy.Symbol(self._debug_name(src))})}."
                        )
                        record_constraint_violation(equalities_inputs.warn_only, self._debug_name(source), msg)
